...
function Collegeform() {
  ...
  return (
    <Flex items="center" justify="center" h="130vh" w="100%" bg="teal.600">
      <FormControl bg="yellow.300" w="50%" height="100%" border="2px solid" p="10">
        ...
        <Flex direction="column" mb="15px" h="60vh" bg="red" p="6" gap="1">
